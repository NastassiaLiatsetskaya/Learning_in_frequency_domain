...
kernel01=AddKernel([ExponentialKernel(input_dims=8,active_dims=[0,1,2,3,4,5,6,7]),
                              MaternKernel(input_dims=8,active_dims=[0,1,2,3,4,5,6,7]),
                              PolynomialKernel(2,input_dims=8,active_dims=[0,1,2,3,4,5,6,7]),
                              RationalQuadraticKernel(input_dims=8,active_dims=[0,1,2,3,4,5,6,7]),
                              SquaredExponentialKernel(input_dims=8,active_dims=[0,1,2,3,4,5,6,7])])

kernel02=AddKernel([ExponentialKernel(input_dims=8,active_dims=[8,9,10,11,12,13,14,15]),
                              MaternKernel(input_dims=8,active_dims=[8,9,10,11,12,13,14,15]),
                              PolynomialKernel(2,input_dims=8,active_dims=[8,9,10,11,12,13,14,15]),
                              RationalQuadraticKernel(input_dims=8,active_dims=[8,9,10,11,12,13,14,15]),
                              SquaredExponentialKernel(input_dims=8,active_dims=[8,9,10,11,12,13,14,15])])

kernel03=AddKernel([ExponentialKernel(input_dims=8,active_dims=[8,9,10,11,12,13,14,15]),
                              MaternKernel(input_dims=8,active_dims=[8,9,10,11,12,13,14,15]),
                              PolynomialKernel(2,input_dims=8,active_dims=[8,9,10,11,12,13,14,15]),
                              RationalQuadraticKernel(input_dims=8,active_dims=[8,9,10,11,12,13,14,15]),
                              SquaredExponentialKernel(input_dims=8,active_dims=[8,9,10,11,12,13,14,15])])

print(list(kernel03.kernels),"subkernels")
...
model1.save("m1_r_sin_nargp_no_freq")
model2.save("m2_r_sin_nargp_no_freq")
model3.save("m3_r_sin_nargp_no_freq")
model4.save("m4_r_sin_nargp_no_freq")
model5.save("m5_r_sin_nargp_no_freq")
#model6.save("m6_r_sin")


model1_im.save("m1_i_sin_nargp_no_freq")
model2_im.save("m2_i_sin_nargp_no_freq")
model3_im.save("m3_i_sin_nargp_no_freq")
model4_im.save("m4_i_sin_nargp_no_freq")
model5_im.save("m5_i_sin_nargp_no_freq")
