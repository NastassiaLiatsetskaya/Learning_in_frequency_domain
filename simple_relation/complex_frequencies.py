...
model1.save("first_real_compl_conv")
model2.save("second_real_compl_conv")
model3.save("third_real_compl_conv")
model4.save("fourth_real_compl_conv")
model1_im.save("first_im_compl_conv")
model2_im.save("second_im_compl_conv")
model3_im.save("third_im_compl_conv")
model4_im.save("fourth_im_compl_conv")