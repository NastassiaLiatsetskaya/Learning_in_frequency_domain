...
x=generate_points(300,500,700,6)
...
kernel5=ExponentialKernel(input_dims=8)
kernel6=PolynomialKernel(3,input_dims=8)
...
model1.save("LMC6_8_input")
model2.save("LMC6_8_input")
model3.save("LMC6_8_input")
model4.save("LMC6_8_input")
