...
f1_imag_cleaned = np.asarray(f1_imag)#[:, 1:5]
...
kernel5_r=AddKernel([ExponentialKernel(), LinearKernel(),MaternKernel(),PolynomialKernel(2),RationalQuadraticKernel(),ExponentialKernel()])
kernel6_r=AddKernel([ExponentialKernel(), LinearKernel(),MaternKernel(),PolynomialKernel(2),RationalQuadraticKernel(),ExponentialKernel()])
...
kernel5_im=AddKernel([ExponentialKernel(), LinearKernel(),MaternKernel(),PolynomialKernel(2), RationalQuadraticKernel(),ExponentialKernel()])
kernel6_im=AddKernel([ExponentialKernel(), LinearKernel(),MaternKernel(),PolynomialKernel(2), RationalQuadraticKernel(),ExponentialKernel()])
...
data5_im=mogptk.DataSet(x_train_imag,y_train_imag[:,4])
model5_im=mogptk.Model(data5_im, kernel5_im)
data6_im=mogptk.DataSet(x_train_imag,y_train_imag[:,5])
...
model1.save("first_real_compl_conv_custom3")
model2.save("second_real_compl_conv_custom3")
model3.save("third_real_compl_conv_custom3")
model4.save("fourth_real_compl_conv_custom3")
model5.save("fifth_real_compl_conv_custom3")
model6.save("sixth_real_compl_conv_custom3")
model1_im.save("first_im_compl_conv_custom3")
model2_im.save("second_im_compl_conv_custom3")
model3_im.save("third_im_compl_conv_custom3")
model4_im.save("fourth_im_compl_conv_custom3")
model5_im.save("fifth_im_compl_conv_custom3")
model6_im.save("sith_im_compl_conv_custom3")