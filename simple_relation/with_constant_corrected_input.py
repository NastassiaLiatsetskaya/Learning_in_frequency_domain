...
import numpy as np
import torch
from mogptk.gpr.singleoutput import  ExponentialKernel,RationalQuadraticKernel,PolynomialKernel, ConstantKernel, SquaredExponentialKernel
...
x=generate_points(400,500,700,10)
...
kernel1=ExponentialKernel(input_dims=12)

kernel3=PolynomialKernel(2, input_dims=12)
kernel4=RationalQuadraticKernel(input_dims=12)
kernel5=SquaredExponentialKernel(input_dims=12)

kernel7=ConstantKernel(input_dims=12)
kernels=[kernel1, kernel3, kernel4, kernel5, kernel7 ]
kernel=LinearModelOfCoregionalizationKernel(kernels,output_dims= 2,input_dims=12,Q=5)
kernel_sec=LinearModelOfCoregionalizationKernel(kernels, output_dims=2,input_dims=12,Q=5)
kernel_third=LinearModelOfCoregionalizationKernel(kernels, output_dims= 2,input_dims=12,Q=5)
kernel_fourth=LinearModelOfCoregionalizationKernel(kernels,output_dims= 2,input_dims=12,Q=5)
kernel_fifth=LinearModelOfCoregionalizationKernel(kernels,output_dims= 2,input_dims=12,Q=5)
kernel_sixth=LinearModelOfCoregionalizationKernel(kernels,output_dims= 2,input_dims=12,Q=5)
#kernel_seventh=LinearModelOfCoregionalizationKernel(kernels,output_dims= 2,input_dims=22,Q=5)
#kernel_8=LinearModelOfCoregionalizationKernel(kernels,output_dims= 2,input_dims=22,Q=5)
#kernel_9=LinearModelOfCoregionalizationKernel(kernels,output_dims= 2,input_dims=22,Q=5)
#kernel_10=LinearModelOfCoregionalizationKernel(kernels,output_dims= 2,input_dims=22,Q=5)
#kernel_11=LinearModelOfCoregionalizationKernel(kernels,output_dims= 2,input_dims=22,Q=5)
...
model1.save("LMC1_10_const3")
model2.save("LMC2_10_const3")
model3.save("LMC3_10_const3")
model4.save("LMC4_10_const3")
model5.save("LMC5_10_const3")
model6.save("LMC6_10_const3")
#model7.save("LMC7_20_const3")
#model8.save("LMC8_20_const3")
##model9.save("LMC9_20_const3")
#model10.save("LMC10_20_const3")
#model11.save("LMC11_20_const3")