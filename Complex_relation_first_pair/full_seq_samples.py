...
points=[]
while i< len(points1):
    f2.append(points2[i:i+100])
    f1.append(points1[i:i+100])
    points.append(x[i:i+100])
    i+=100
...
kernel1_r=AddKernel([ExponentialKernel(input_dims=202), MaternKernel(input_dims=202),
                     PolynomialKernel(2,input_dims=202), RationalQuadraticKernel(input_dims=202),
                     SquaredExponentialKernel(input_dims=202)])
...
model2.save("m2_r_sin100")
model3.save("m3_r_sin100")
model4.save("m4_r_sin100")
model5.save("m5_r_sin100")
#model6.save("m6_r_sin")


model1_im.save("m1_i_sin100")
model2_im.save("m2_i_sin100")
model3_im.save("m3_i_sin100")
model4_im.save("m4_i_sin100")
model5_im.save("m5_i_sin100")
