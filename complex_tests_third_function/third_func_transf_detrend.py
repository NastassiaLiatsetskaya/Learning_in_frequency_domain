...
kernel1_r=AddKernel([ExponentialKernel(input_dims=17), MaternKernel(input_dims=17),PolynomialKernel(2,input_dims=17),
                     RationalQuadraticKernel(input_dims=17), SquaredExponentialKernel(input_dims=17)])
...
data1.transform(mogptk.TransformDetrend)
data1.transform(mogptk.TransformNormalize())
model1=mogptk.Model(data1,kernel1_r)

data2=mogptk.DataSet(x_train_real,y_train_real[:,1])
data2.transform(mogptk.TransformDetrend)
data2.transform(mogptk.TransformNormalize())
model2=mogptk.Model(data2,kernel2_r)

data3=mogptk.DataSet(x_train_real,y_train_real[:,2])
data3.transform(mogptk.TransformDetrend)
data3.transform(mogptk.TransformNormalize())
model3=mogptk.Model(data3, kernel3_r)

data4=mogptk.DataSet(x_train_real,y_train_real[:,3])
data4.transform(mogptk.TransformDetrend)
data4.transform(mogptk.TransformNormalize())
model4=mogptk.Model(data4,kernel4_r)

data5=mogptk.DataSet(x_train_real,y_train_real[:,4])
print(data5[0])
data5.transform(mogptk.TransformDetrend)
data5.transform(mogptk.TransformNormalize())
...
#data1_im.transform(mogptk.TransformDetrend)
#data1_im.transform(mogptk.TransformNormalize())
#print("transformed")
#print(data1_im[0])
#model1_im=mogptk.Model(data1_im, kernel1_im)

data2_im=mogptk.DataSet(x_train_real,y_train_imag[:,1])
data2_im.transform(mogptk.TransformDetrend)
data2_im.transform(mogptk.TransformNormalize())
model2_im=mogptk.Model(data2_im, kernel2_im)

data3_im=mogptk.DataSet(x_train_real,y_train_imag[:,2])
data3_im.transform(mogptk.TransformDetrend)
data3_im.transform(mogptk.TransformNormalize())
model3_im=mogptk.Model(data3_im, kernel3_im)

data4_im=mogptk.DataSet(x_train_real,y_train_imag[:,3])
data4_im.transform(mogptk.TransformDetrend)
data4_im.transform(mogptk.TransformNormalize())
model4_im=mogptk.Model(data4_im, kernel4_im)

data5_im=mogptk.DataSet(x_train_real,y_train_imag[:,4])
#data5_im.transform(mogptk.TransformDetrend)
#data5_im.transform(mogptk.TransformNormalize())
...
model1.save("m1_r_sin_detr")
model2.save("m2_r_sin_detr")
model3.save("m3_r_sin_detr")
model4.save("m4_r_sin_detr")
model5.save("m5_r_sin_detr")
#model6.save("m6_r_sin")


#model1_im.save("m1_i_sin_detr")
model2_im.save("m2_i_sin_detr")
model3_im.save("m3_i_sin_detr")
model4_im.save("m4_i_sin_detr")
model5_im.save("m5_i_sin_detr")
#model6_im.save("m6_i_sin")
print(end-start, "custom freq")