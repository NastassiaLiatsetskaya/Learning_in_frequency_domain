...
model1.save("m1_r_sin")
model2.save("m2_r_sin")
model3.save("m3_r_sin")
model4.save("m4_r_sin")
model5.save("m5_r_sin")
#model6.save("m6_r_sin")


model1_im.save("m1_i_sin")
model2_im.save("m2_i_sin")
model3_im.save("m3_i_sin")
model4_im.save("m4_i_sin")
model5_im.save("m5_i_sin")
