...
model1.save("m1_r_sin_sm_orig")
model2.save("m2_r_sin_sm_orig")
model3.save("m3_r_sin_sm_orig")
model4.save("m4_r_sin_sm_orig")
model5.save("m5_r_sin_sm_orig")
#model6.save("m6_r_sin")


model1_im.save("m1_i_sin_sm_orig")
model2_im.save("m2_i_sin_sm_orig")
model3_im.save("m3_i_sin_sm_orig")
model4_im.save("m4_i_sin_sm_orig")
model5_im.save("m5_i_sin_sm_orig")
#model6_im.save("m6_i_sin")

print(end-start, "orig sm time")
model1.predict()