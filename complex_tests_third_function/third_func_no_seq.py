...
kernel1_r=AddKernel([ExponentialKernel(input_dims=2), MaternKernel(input_dims=2),PolynomialKernel(2,input_dims=2), RationalQuadraticKernel(input_dims=2),
