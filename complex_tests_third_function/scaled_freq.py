...
model1.save("m1_r_freqsc")
model2.save("m2_r_freqsc")
model3.save("m3_r_freqsc")
model4.save("m4_r_freqsc")
model5.save("m5_r_freqsc")
#model6.save("m6_r_sin")


model1_im.save("m1_i_freqsc")
model2_im.save("m2_i_freqsc")
model3_im.save("m3_i_freqsc")
model4_im.save("m4_i_freqsc")
model5_im.save("m5_i_freqsc")
