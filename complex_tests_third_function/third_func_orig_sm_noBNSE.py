...
kernel1_r=SpectralMixtureKernel(Q=15,input_dims=8)
...
model1.save("m1_r_sin_sm_orig_BNSE60")
model2.save("m2_r_sin_sm_orig_BNSE60")
model3.save("m3_r_sin_sm_orig_BNSE60")
model4.save("m4_r_sin_sm_orig_BNSE60")
model5.save("m5_r_sin_sm_orig_BNSE60")
#model6.save("m6_r_sin")


model1_im.save("m1_i_sin_sm_orig_BNSE60")
model2_im.save("m2_i_sin_sm_orig_BNSE60")
model3_im.save("m3_i_sin_sm_orig_BNSE60")
model4_im.save("m4_i_sin_sm_orig_BNSE60")
model5_im.save("m5_i_sin_sm_orig_BNSE60")
#model6_im.save("m6_i_sin")
print(end-start, "bnse orig")
#all bnse has failed