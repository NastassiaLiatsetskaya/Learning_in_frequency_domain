...
model1.save("m1_r_convo_p")
model2.save("m2_r_convo_p")
model3.save("m3_r_convo_p")
model4.save("m4_r_convo_p")
model5.save("m5_r_convo_p")
model6.save("m6_r_convo_p")


model1_im.save("m1_i_convo_p")
model2_im.save("m2_i_convo_p")
model3_im.save("m3_i_convo_p")
model4_im.save("m4_i_convo_p")
model5_im.save("m5_i_convo_p")
model6_im.save("m6_i_convo_p")