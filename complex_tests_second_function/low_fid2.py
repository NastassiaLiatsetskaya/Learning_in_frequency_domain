...
while i< len(conv_points):
    ...
    i+=10
print(np.asarray(points).shape, "shape")
...
kernel1_r=AddKernel([ MaternKernel(input_dims=10),PolynomialKernel(2,input_dims=10), ExponentialKernel(input_dims=10)])
...
model1.save("m1_r_convo_low_fid")
model2.save("m2_r_convo_low_fid")
model3.save("m3_r_convo_low_fid")
model4.save("m4_r_convo_low_fid")
model5.save("m5_r_convo_low_fid")
model6.save("m6_r_convo_low_fid")


model1_im.save("m1_i_convo_low_fid")
model2_im.save("m2_i_convo_low_fid")
model3_im.save("m3_i_convo_low_fid")
model4_im.save("m4_i_convo_low_fid")
model5_im.save("m5_i_convo_low_fid")
model6_im.save("m6_i_convo_low_fid")