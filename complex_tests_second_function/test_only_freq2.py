...
rand_index=np.random.choice(2000,700,replace=False)
points1=[low_fidelity(i) for i in x ]
conv_points=np.convolve(points1, points1, mode='full')
conv_points=conv_points[3500:10500]
...
for i in range(700):
    ...
    real_train.append(rand_index[i])
...
model1.save("m1_r_convo_random")
model2.save("m2_r_convo_random")
model3.save("m3_r_convo_random")
model4.save("m4_r_convo_random")
model5.save("m5_r_convo_random")
model6.save("m6_r_convo_random")


model1_im.save("m1_i_convo_random")
model2_im.save("m2_i_convo_random")
model3_im.save("m3_i_convo_random")
model4_im.save("m4_i_convo_random")
model5_im.save("m5_i_convo_random")
model6_im.save("m6_i_convo_random")