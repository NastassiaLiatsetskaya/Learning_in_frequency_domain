...
kernel1_r=AddKernel([ExponentialKernel(input_dims=12), MaternKernel(input_dims=12),PolynomialKernel(2,input_dims=12), RationalQuadraticKernel(input_dims=12), SquaredExponentialKernel(input_dims=12)])
...
model1.save("m1_r_only")
model2.save("m2_r_only")
model3.save("m3_r_only")
model4.save("m4_r_only")
model5.save("m5_r_only")
model6.save("m6_r_only")


model1_im.save("m1_i_only")
model2_im.save("m2_i_only")
model3_im.save("m3_i_only")
model4_im.save("m4_i_only")
model5_im.save("m5_i_only")
model6_im.save("m6_i_only")