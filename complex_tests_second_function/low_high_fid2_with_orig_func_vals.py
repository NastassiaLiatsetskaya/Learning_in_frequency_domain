...
m1_real = mogptk.LoadModel("m1_r_convo_p6")
m2_real = mogptk.LoadModel('m2_r_convo_p6')
m3_real = mogptk.LoadModel('m3_r_convo_p6')
m4_real = mogptk.LoadModel('m4_r_convo_p6')
m5_real = mogptk.LoadModel('m5_r_convo_p6')
m6_real = mogptk.LoadModel('m6_r_convo_p6')

m7_real = mogptk.LoadModel("m7_r_convo_p6")
m8_real = mogptk.LoadModel('m8_r_convo_p6')
m9_real = mogptk.LoadModel('m9_r_convo_p6')
m10_real = mogptk.LoadModel('m10_r_convo_p6')
...
_, im, _, _ = m7_real.predict(x_tr)
_, im2, _, _ = m8_real.predict(x_tr)
_, im3, _, _ = m9_real.predict(x_tr)
_, im4, _, _ = m10_real.predict(x_tr)

predictions = []
for r1,r2,r3,r4,r5,r6,r7,r8,r9,r10 in zip(real, real2, real3, real4, real5,real6, im, im2, im3, im4):
    predictions.append([r1,r2,r3,r4,r5,r6,r7,r8,r9,r10])

print(np.asarray(predictions).shape,"shape predictions")
...
kernel1_r=AddKernel([ MaternKernel(input_dims=11),PolynomialKernel(2,input_dims=11),
                     SquaredExponentialKernel(input_dims=11)])
...
model7.save("m7_r_convo_lh")
model8.save("m8_r_convo_lh")
model9.save("m9_r_convo_lh")
model10.save("m10_r_convo_lh")
