...
x_tr =np.asarray(input)

m1_real = mogptk.LoadModel("m1_r_convo_p2")
m2_real = mogptk.LoadModel('m2_r_convo_p2')
m3_real = mogptk.LoadModel('m3_r_convo_p2')
m4_real = mogptk.LoadModel('m4_r_convo_p2')
m5_real = mogptk.LoadModel('m5_r_convo_p2')
m6_real = mogptk.LoadModel('m6_r_convo_p2')

m1_im = mogptk.LoadModel("m1_i_convo_p2")
m2_im = mogptk.LoadModel('m2_i_convo_p2')
m3_im = mogptk.LoadModel('m3_i_convo_p2')
m4_im = mogptk.LoadModel('m4_i_convo_p2')
m5_im = mogptk.LoadModel('m5_i_convo_p2')
m6_im = mogptk.LoadModel('m6_i_convo_p2')

_, real, _, _ = m1_real.predict(x_tr)
_, real2, _, _ = m2_real.predict(x_tr)
_, real3, _, _ = m3_real.predict(x_tr)
_, real4, _, _ = m4_real.predict(x_tr)
_, real5, _, _ = m5_real.predict(x_tr)
_, real6, _, _ = m6_real.predict(x_tr)

_, im, _, _ = m1_im.predict(x_tr)
_, im2, _, _ = m2_im.predict(x_tr)
_, im3, _, _ = m3_im.predict(x_tr)
_, im4, _, _ = m4_im.predict(x_tr)
_, im5, _, _ = m5_im.predict(x_tr)
_, im6, _, _ = m6_im.predict(x_tr)
predictions = []
for r, i,r2,i2,r3,i3,r4,i4,r5,i5,r6,i6 in zip(real,im,real2,im2,real3,im3,real4,im4,real5,im5,real6,im6):
    predictions.append([r,i,r2,i2,r3,i3,r4,i4,r5,i5,r6,i6])
...
for i in range(500):
    ...
    f1_real.append(predictions[i]+[points[i][0]])
    real_train2=[]
    imag_train2=[]
    for k in value2:
...
kernel1_r=AddKernel([ MaternKernel(input_dims=13),PolynomialKernel(2,input_dims=13),
                     SquaredExponentialKernel(input_dims=13)])
...
model1.save("m1_r_convo_lh")
model2.save("m2_r_convo_lh")
model3.save("m3_r_convo_lh")
model4.save("m4_r_convo_lh")
model5.save("m5_r_convo_lh")
model6.save("m6_r_convo_lh")


model1_im.save("m1_i_convo_lh")
model2_im.save("m2_i_convo_lh")
model3_im.save("m3_i_convo_lh")
model4_im.save("m4_i_convo_lh")
model5_im.save("m5_i_convo_lh")
model6_im.save("m6_i_convo_lh")