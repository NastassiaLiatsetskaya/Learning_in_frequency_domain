...
model1.save("first_real2")
model2.save("second_real2")
model3.save("third_real2")
model4.save("fourth_real2")
model1_im.save("first_im2")
model2_im.save("second_im2")
model3_im.save("third_im2")
model4_im.save("fourth_im2")
