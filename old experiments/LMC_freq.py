...
model_real.train(method="Adam", iters=1500, error="MAE")
print("first trained", model_real.log_marginal_likelihood())
model_imag.train(method="Adam", iters=1500, error="MAE")
print("second trained", model_imag.log_marginal_likelihood())
model_real.save("model_real_convolved")
model_imag.save("model_imag_convolved")
