...
for i in range(num_training_samples):
    index=i+i*8
    x_train.append(np.linspace(index/3599, (index+8)/3599, 8))
...
kernel5_r=AddKernel([ExponentialKernel(), LinearKernel(),MaternKernel()])
...
kernel5_im=AddKernel([  ExponentialKernel(), LinearKernel(),MaternKernel()])
...
model5.train(method="Adam", plot=True, iters=200, error="MAE")
...
model5_im.train(method="Adam", plot=True, iters=200, error="MAE")
print(model5_im.log_marginal_likelihood(), "trained")


model1.save("first_real_kernel3_8")
model2.save("second_real_kernel3_8")
model3.save("third_real_kernel3_8")
model4.save("fourth_real_kernel3_8")
model1_im.save("first_im_kernel3_8")
model2_im.save("second_im_kernel3_8")
model3_im.save("third_im_kernel3_8")
model4_im.save("fourth_im_kernel3_8")