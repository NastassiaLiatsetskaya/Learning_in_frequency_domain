...
model1.save("first_real_kernel3")
model2.save("second_real_kernel3")
model3.save("third_real_kernel3")
model4.save("fourth_real_kernel3")
model1_im.save("first_im_kernel3")
model2_im.save("second_im_kernel3")
model3_im.save("third_im_kernel3")
model4_im.save("fourth_im_kernel3")