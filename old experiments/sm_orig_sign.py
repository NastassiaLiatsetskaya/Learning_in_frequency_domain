...
model1.save("f_independent_sm2")
model2.save("s_independent_sm2")
model3.save("t_independent_sm2")
model4.save("f1_independent_sm2")
model5.save("ff_independent_sm2")
model6.save("si_independent_sm2")
#BNSE failed by training