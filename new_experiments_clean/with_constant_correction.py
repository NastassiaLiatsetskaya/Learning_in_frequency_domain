...
from mogptk.gpr.singleoutput import LinearKernel, ExponentialKernel,RationalQuadraticKernel, MaternKernel, PolynomialKernel, ConstantKernel, SquaredExponentialKernel
...
x=generate_points(400,500,700,20)
...
kernel5=SquaredExponentialKernel()
...
model1.save("LMC1_20_const2")
model2.save("LMC2_20_const2")
model3.save("LMC3_20_const2")
model4.save("LMC4_20_const2")
model5.save("LMC5_20_const2")
model6.save("LMC6_20_const2")
model7.save("LMC7_20_const2")
model8.save("LMC8_20_const2")
model9.save("LMC9_20_const2")
model10.save("LMC10_20_const2")
model11.save("LMC11_20_const2")