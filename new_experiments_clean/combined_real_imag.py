...
for i in range(500):
    value1 = rfft(f1[i])
    value2 = rfft(f2[i])
    f1_real.append([np.concatenate(i.real, i.imag) for i in value1])
 #   f1_imag.append([i.imag for i in value1])

#
    f2_real.append([np.concatenate(i.real, i.imag) for i in value2])
...
model1.save("first_real_compl_conv_custom2")
model2.save("second_real_compl_conv_custom2")
model3.save("third_real_compl_conv_custom2")
model4.save("fourth_real_compl_conv_custom2")
model1_im.save("first_im_compl_conv_custom2")
model2_im.save("second_im_compl_conv_custom2")
model3_im.save("third_im_compl_conv_custom2")
model4_im.save("fourth_im_compl_conv_custom2")