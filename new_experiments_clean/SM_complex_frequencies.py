...
from mogptk.gpr.multioutput import LinearModelOfCoregionalizationKernel, IndependentMultiOutputKernel, MultiOutputSpectralMixtureKernel
...
kernel=MultiOutputSpectralMixtureKernel(15,output_dims= 2,input_dims=12)
kernel_sec=MultiOutputSpectralMixtureKernel(15,output_dims= 2,input_dims=12)
kernel_third=MultiOutputSpectralMixtureKernel(15, output_dims=2,input_dims=12)
kernel_fourth=MultiOutputSpectralMixtureKernel(15, output_dims= 2,input_dims=12)
kernel_fifth=MultiOutputSpectralMixtureKernel(15,output_dims= 2,input_dims=12)
kernel_sixth=MultiOutputSpectralMixtureKernel(15,output_dims= 2,input_dims=12)
...
model1.save("SM1_10_const3")
model2.save("SM2_10_const3")
model3.save("SM3_10_const3")
model4.save("SM4_10_const3")
model5.save("SM5_10_const3")
model6.save("SM6_10_const3")