...
model1.save("first_real_compl_conv_custom4")
model2.save("second_real_compl_conv_custom4")
model3.save("third_real_compl_conv_custom4")
model4.save("fourth_real_compl_conv_custom4")
model1_im.save("first_im_compl_conv_custom4")
model2_im.save("second_im_compl_conv_custom4")
model3_im.save("third_im_compl_conv_custom4")
model4_im.save("fourth_im_compl_conv_custom4")