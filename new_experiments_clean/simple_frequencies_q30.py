...
print(np.asarray(f1_imag)[:10], "imaginary values")
for i in (f1_imag):
    if i[0]!=0:
        print("first no")
    if i[3]!=0:
...
model1.save("first_real30")
model2.save("second_real30")
model3.save("third_real30")
model4.save("fourth_real30")
model1_im.save("first_im30")
model2_im.save("second_im30")
model3_im.save("third_im30")
model4_im.save("fourth_im30")