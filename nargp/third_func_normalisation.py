...
model1.save("m1_r_sin_norm")
model2.save("m2_r_sin_norm")
model3.save("m3_r_sin_norm")
model4.save("m4_r_sin_norm")
model5.save("m5_r_sin_norm")
#model6.save("m6_r_sin")


model1_im.save("m1_i_sin_norm")
model2_im.save("m2_i_sin_norm")
model3_im.save("m3_i_sin_norm")
model4_im.save("m4_i_sin_norm")
model5_im.save("m5_i_sin_norm")
